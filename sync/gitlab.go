...
Write access_token in config file (pet configure) or export $%v.
	...
	if viper.GetString("gitlab.url") != "" {
		client.Client.SetBaseURL(viper.GetString("gitlab.url"))
	}

	if viper.GetString("gitlab.id") == "" {
		return client, nil
	}

	id := viper.GetInt("gitlab.id")
	if err != nil {
...
func getGitlabAccessToken() (string, error) {
	if viper.GetString("gitlab.access_token") != "" {
		return viper.GetString("gitlab.access_token"), nil
...
func (g GitLabClient) GetSnippet() (*Snippet, error) {
	...
	filename := viper.GetString("gitlab.file_name")
...
func (g GitLabClient) createSnippet(ctx context.Context, content string) (id int, err error) {
	...
	opt := &gitlab.CreateSnippetOptions{
		...
		FileName:    gitlab.String(viper.GetString("gitlab.file_name")),
		Description: gitlab.String("Snippet file generated by pet"),
		Content:     gitlab.String(content),
		Visibility:  gitlab.Visibility(gitlab.VisibilityValue(viper.GetString("gitlab.visibility"))),
	}
